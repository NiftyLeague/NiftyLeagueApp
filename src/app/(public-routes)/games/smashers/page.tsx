...
const GameWithAuth = dynamic(
  () => import('@/components/wrapper/GameWithAuth'),
  { ssr: false },
);
...
const SmashersGame = () => (
  <>
    <div style={{ marginBottom: 20 }}>
      <strong>
        Note: This is a deprecated version of Nifty Smashers. If you&apos;re
        looking for our latest mobile game please visit{' '}
        <a
