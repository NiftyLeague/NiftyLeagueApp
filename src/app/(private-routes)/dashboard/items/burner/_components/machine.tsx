...
> = memo(({ burnDisabled, imx, selectedComics }) => {
  ...
  return (
    <>
      <MachineFrame
        frames={['/images/comics/burner/machine/machine_main_3.png']}
      />
      <MachineFrame
        frames={['/images/comics/burner/machine/fx_combined_02.gif']}
      />
      {!imx.registeredUser ? (
        <MachineFrame
          frames={[
      ...
      <MachineFrame
        frames={['/images/comics/burner/machine/button_help_1.png']}
      />
      {!burnDisabled ? (
        <MachineFrame
          frames={[
        ...
        <>
          {!imx.registeredUser ? (
            <MachineFrame
              frames={[
                '/images/comics/burner/machine/connectwalletabove_button_01.png',
              ]}
            />
          ) : null}
          {selectedComics.length < 1 ? (
            <MachineFrame
              frames={[
                '/images/comics/burner/machine/selectcomics_button_02.png',
              ]}
            />
          ) : null}
          {imx.registeredUser && selectedComics.length > 1 ? (
            <MachineFrame
              frames={['/images/comics/burner/machine/button_burn_gray_01.png']}
            />
          ) : null}
        </>
      )}
