...
export const MERKLE_DISTRIBUTOR_ADDRESS = {
  ...
  [mainnet.id]: '0x921c673a4d2f6a429551c0726316c1ad07571db5',
  [goerli.id]: '0xFeB2f45A3817EF9156a6c771FfC90098d3DFe003',
};
...
export const COMICS_MERKLE_DISTRIBUTOR_ADDRESS = {
  ...
  [mainnet.id]: '0x038FbfE31A113952C15C688Df5b025959f589ad7',
  [goerli.id]: '0x5DCcEEd8E10a3EE1aF095B248ad66E8F33875045',
};
...
export const IMX_NL_ITEMS = {
  [mainnet.id]: '0xc21909b7E596000C01318668293A7DFB4B37A578',
  [goerli.id]: '0xbf1238C6aF46C19169c921e6058E330a97040CFD',
};

export const NFTL_TOKEN_ADDRESS = {
  [mainnet.id]: '0x3c8D2FCE49906e11e71cB16Fa0fFeB2B16C29638',
  [goerli.id]: '0x5803033a15F49dA0664ff8b0775a6E578422CAfD',
};
