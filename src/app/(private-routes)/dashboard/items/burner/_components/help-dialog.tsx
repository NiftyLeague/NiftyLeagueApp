...
export default function DraggableDialog({ open, setOpen }) {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogContentText>
          Welcome to SATOSHI&apos;S COMICS BURNING MACHINE where you can burn
          your COMICS for in-game WEARABLE ITEMS!
          <ul style={{ lineHeight: 2 }}>
            ...
            <li>
              CONSOLE 2 shows you the total KEYS and ITEMS you&apos;ll receive
              for burning your selected COMICS.
            </li>
            <li>
